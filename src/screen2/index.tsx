...
interface SecondPanelProps {
    navigation:{navigate: (scene:String, params:any) => void, state:any};
}
...
class SecondPanel extends RX.Component<SecondPanelProps, SecondPanelState> {
    ...
    componentWillUnmount() {
     ...
     private _onPressNavigate = () => {
         // send the key of this screen to the next use for goBack
        this.props.navigation.navigate("S1S3",{key:this.props.navigation.state.key});
    }
