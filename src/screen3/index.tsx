...
interface ThirdPanelProps {
    navigation:{goBack: (key:String) => void, state:any};
}

interface ThirdPanelState {
    toggleValue?: boolean;
...
class ThirdPanel extends RX.Component<ThirdPanelProps, ThirdPanelState> {
    ...
    componentWillUnmount() {
     ...
     private _onPressNavigate = () => {
        // set to go back to sceen prior to screen2
